...
CA[600];
        ...
        setlocale(LC_ALL,"");//Configura regionalidade
        system("cls");
                    ...
                    for (i=1;i<=qtd;i++)
                        {
                            ...
                            fprintf(cfPtr, "\n NOME DO PACIENTE: %s\n CPF: %s\n TELEFONE: %s\n CEP: %s\n RUA: %s\n NÚMERO: %s BAIRRO: %s\n CIDADE: %s\n ESTADO: %s\n ",
                                    CA[i].nome, CA[i].cpf,CA[i].telefone,CA[i].cep,CA[i].rua,CA[i].nrua,CA[i].bairro,CA[i].cidade,CA[i].estado );
                            printf("PRESSIONE CTRL+Z PARA ENCERRAR ");
                            scanf("%s%s%s%s%s%s%s%s%s",CA[i].nome,CA[i].cpf,CA[i].telefone,CA[i].cep,CA[i].rua,CA[i].nrua,CA[i].bairro,CA[i].cidade,CA[i].estado);
                            }
